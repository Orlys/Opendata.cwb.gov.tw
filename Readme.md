...
## 教學
1. 先登入 [氣象資料開放平台](https://opendata.cwb.gov.tw)<br>
2. 按下 [此頁](https://opendata.cwb.gov.tw/devManual/insrtuction#getUserAuthkeyAnchor) 中的 ![取得授權碼](./img/getAuthCode.png) 取得右方的授權碼並複製<br>
3. 複製下方的程式碼
```csharp
using Opendata.Core;
```
